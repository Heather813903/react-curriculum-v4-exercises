...
// Explanation:
// The message was stored in a regular variable instead of state.
// React does not track changes to regular variables.
// Using useState and setMessage allows React to update the UI.
